...
AMyProject4PlayerController::AMyProject4PlayerController()
{
...
void AMyProject4PlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AMyProject4PlayerController::OnResetVR);
}

void AMyProject4PlayerController::OnResetVR()
{
...
void AMyProject4PlayerController::MoveToMouseCursor()
{
	...
	{
		if (AMyProject4Character* MyPawn = Cast<AMyProject4Character>(GetPawn()))
		{
